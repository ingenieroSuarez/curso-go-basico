...
import (
	...
	_ "github.com/lib/pq" // DEBO USAR ESTO PARA QUE FUNCIONE
...
// IMPLEMENTACION CONCRETA, EL REPOSITORIO ES ABSTRACTO (D de SOLID)
func NewPostgresRepository(url string) (*PostgresRepository, error) { // constructor del repositorio
...
func (repo *PostgresRepository) Close() error { // esto es lo que esta en repository, pero lo implemento acá
